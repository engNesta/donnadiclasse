...
const Products = () => {
  ...
  const productsByCategory = {
    ...
    bags: [
      { id: 1, name: "Elegant Läderväska", price: "1999 kr", image: "/Products/Bags/Bag 1.jpg" },
      { id: 2, name: "Klassisk Handväska", price: "2499 kr", image: "/Products/Bags/Bag 2.jpg" },
      { id: 3, name: "Modern Axelremsväska", price: "1799 kr", image: "/Products/Bags/Bag 3.jpg" },
      { id: 4, name: "Stilren Aftonväska", price: "2999 kr", image: "/Products/Bags/Bag 4.jpg" },
      { id: 5, name: "Trendig Handväska", price: "2199 kr", image: "/Products/Bags/Bag 5.jpg" },
      { id: 6, name: "Exklusiv Designväska", price: "3499 kr", image: "/Products/Bags/Bag 6.jpg" },
      { id: 7, name: "Premium Läderväska", price: "2799 kr", image: "/Products/Bags/Bag 7.jpg" },
      { id: 8, name: "Lyxig Aftonväska", price: "3999 kr", image: "/Products/Bags/Bag 8.jpg" },
    ],
    jewelry: [
