      ...
      <main className="flex-grow">
        <div className="hero-video-wrapper">
          ...
          <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center">
            <div className="text-center text-soft-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)] mb-16">
            ...
            <div className="text-soft-white max-w-3xl mx-auto text-center space-y-6 px-4">
